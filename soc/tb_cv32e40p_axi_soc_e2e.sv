...
module cv32e40p_top #(
  ...
  localparam logic [31:0] TEST_ADDR  = SOC_EXT_TEST_BASE_ADDR;
  localparam logic [31:0] TEST_WDATA = 32'hCAFE_BABE;
    ...
    if (!rst_ni) begin
      ...
      unique case (state_q)
        ST_IDLE: begin
          ...
          data_we_o    <= 1'b1;
          data_be_o    <= 4'hf;
          data_addr_o  <= TEST_ADDR;
          data_wdata_o <= TEST_WDATA;
        ...
        ST_READ_RESP: begin
          if (data_rvalid_i) begin
            if (data_rdata_i !== TEST_WDATA) begin
              $display("tb_cv32e40p_axi_soc_e2e: readback mismatch %h != %h",
                       data_rdata_i, TEST_WDATA);
              $fatal(1);
            end

            $display("tb_cv32e40p_axi_soc_e2e: PASS");
            state_q <= ST_DONE;
          end
        end
...
module tb_cv32e40p_axi_soc_e2e;
  ...
  initial begin
    ...
    $display("tb_cv32e40p_axi_soc_e2e: TIMEOUT");
    $fatal(1);
  end
